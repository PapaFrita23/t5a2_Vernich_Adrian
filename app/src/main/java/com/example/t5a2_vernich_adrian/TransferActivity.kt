    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spCuentasP.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                Toast.makeText(this@TransferActivity, "Seleccionaste: $opcionSeleccionada2", Toast.LENGTH_LONG).show()
            }
        ...
        spMonedas.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                Toast.makeText(this@TransferActivity, "Seleccionaste: $opcionSeleccionada3", Toast.LENGTH_LONG).show()
            }
